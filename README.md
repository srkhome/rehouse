...
這是一個三頁式行銷名單收集網站，用於宣傳「為老重建」免費說明會。網站風格為明亮淺藍主題，採用 HTML + CSS + JavaScript 製作，無需伺服器即可在 GitHub Pages 上運作。
...
明亮淺藍主題：主色為 #f0f7ff、按鈕藍 #007bff、輔色青 #00bcd4。
...
git clone https://github.com/yourname/為老重建-名單網站.git
cd 為老重建-名單網站


或直接上傳 為老重建_名單收集網站_淺藍版.zip 至 GitHub。
